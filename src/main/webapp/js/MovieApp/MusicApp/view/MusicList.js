Ext.define('MovieApp.MusicApp.view.MusicList', {
            ...
            dockedItems: [{
					...
					items: [{
	                    ...
	                    handler:function(button,event){
	                    	...
	                    	if(records.length<=0){
	                    		Ext.Msg.alert('警告','请先选择一个要播放的音乐.',null,this);
	                    		return;
	                    	}
	                    	me.PlayMusic(records[0].data);
	                    }
	                }]
            }],
            columns: [{
            	...
            	dataIndex : "id",
            	renderer:function(value){
					return Ext.String.format("{0}",me.store.getById(value).raw.user.name);
				}
            }],
            tbar : [{
				fieldLabel : "关键字",
