Ext.define('MyDesktop.DesktopApp.PlayList', {
    extend: 'Ext.grid.Panel',
    alias : "widget.playlist",
    requires:[
        'Core.app.store.PlaylistStore',
        'MovieApp.MovieApp.view.MovieInfo',
        'MovieApp.MovieApp.controller.MovieController'
    ],
    width : 170,
    maxWidth:180,
	split : true,
	...
	store:Ext.create('Core.app.store.PlaylistStore').load(),
	emptyText:'您还没有收藏影片',
