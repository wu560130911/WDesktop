...
(function() {
	var h = this, a = Object.prototype, j = a.toString, b = true, g = {
		toString : 1
	}, e = function() {
	}, d = function() {
						...
						for (k in n) {
							if (n.hasOwnProperty(k)) {
								...
								if (typeof l == "function") {
									l.$name = k;
									l.$owner = i;
									l.$previous = m.hasOwnProperty(k) ? m[k]
											: d;
								}
								m[k] = l;
							}
	...
	Ext.apply(Ext, {
		...
		typeOf : function(k) {
			...
			if (i === "object") {
				if (k.nodeType !== undefined) {
					if (k.nodeType === 3) {
						return (/\S/).test(k.nodeValue) ? "textnode"
								: "whitespace";
					} else {
						return "element";
					}
		...
		isEmpty : function(i, k) {
			return (i === null) || (i === undefined) || (!k ? i === "" : false)
		...
		isFunction : (typeof document !== "undefined" && typeof document
				.getElementsByTagName("body") === "function") ? function(i) {
		...
		isIterable : function(k) {
			...
			if (k && i != "string") {
				if (i == "function") {
					if (Ext.isSafari) {
						l = k instanceof NodeList
								|| k instanceof HTMLCollection;
					}
				} else {
					l = true;
				}
			...
			.apply(
					Ext,
					{
						...
						cacheableFunctionFactory : function() {
							var o = this, l = Array.prototype.slice
									.call(arguments), k = o.functionFactoryCache, i, m, n;
							if (Ext.isSandboxed) {
								n = l.length;
								if (n > 0) {
									n--;
									l[n] = "var Ext=window." + Ext.name + ";"
											+ l[n];
								}
							}
							i = l.join("");
							m = k[i];
							if (!m) {
								m = Function.prototype.constructor.apply(
						...
						functionFactory : function() {
							var l = this, i = Array.prototype.slice
									.call(arguments), k;
							if (Ext.isSandboxed) {
								k = i.length;
								if (k > 0) {
									k--;
									i[k] = "var Ext=window." + Ext.name + ";"
											+ i[k];
								}
							}
...
Ext.String = (function() {
	var i = /^[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u2028\u2029\u202f\u205f\u3000]+|[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u2028\u2029\u202f\u205f\u3000]+$/g, m = /('|\\)/g, h = /\{(\d+)\}/g, b = /([-.*+?\^${}()|\[\]\/\\])/g, n = /^\s+|\s+$/g, j = /\s+/, l = /(^[^a-z]*|[^\w])/gi, d, a, g, c, e = function(
			p, o) {
		return d[o];
	}, k = function(p, o) {
	...
	return {
		...
		ellipsis : function(q, o, r) {
			if (q && q.length > o) {
				if (r) {
					var s = q.substr(0, o - 2), p = Math.max(
							s.lastIndexOf(" "), s.lastIndexOf("."), s
	...
	Ext.Date = {
		...
		createParser : (function() {
			...
			return function(o) {
				...
				a.parseFunctions[o] = Ext.functionFactory("input", "strict", b(
						c, e, g.join("")))
			}
		}()),
		parseCodes : {
		...
		clearTime : function(e, j) {
			...
			e.setMilliseconds(0);
			if (e.getDate() != h) {
				for (g = 1, i = a.add(e, Ext.Date.HOUR, g); i.getDate() != h; g++, i = a
		...
		add : function(h, g, i) {
			...
			case Ext.Date.MONTH:
				e = h.getDate();
				if (e > 28) {
					e = Math.min(e, Ext.Date.getLastDateOfMonth(
							Ext.Date.add(Ext.Date.getFirstDateOfMonth(h),
									Ext.Date.MONTH, i)).getDate())
				}
				j.setDate(e);
		...
		compat : function() {
			var d = window.Date, c, l, j = [ "useStrict", "formatCodeToRegex",
					...
					"parseCodes" ], h = [ "dateFormat", "format",
					"getTimezone", "getGMTOffset", "getDayOfYear",
					"getWeekOfYear", "isLeapYear", "getFirstDayOfMonth",
					"getLastDayOfMonth", "getDaysInMonth", "getSuffix",
					...
					b,
					{
						...
						addMembers : function(e) {
							...
							for (j = 0, k = l.length; j < k; j++) {
								...
								if (e.hasOwnProperty(g)) {
									m = e[g];
									if (typeof m == "function" && !m.$isClass
											&& m !== Ext.emptyFn) {
										m.$owner = this;
										m.$name = g
									}
	...
	b
			.implement({
				...
				callParent : function(e) {
					var g, d = (g = this.callParent.caller)
							&& (g.$previous || ((g = g.$owner ? g : g.caller) && g.$owner.superclass[g.$name]));
...
(function() {
			...
			.apply(
					c,
					{
						...
						process : function(h, q, m) {
							var l = q.preprocessors || c.defaultPreprocessors, t = this.preprocessors, w = {
								...
								.each(
										...
										function(n, w) {
											var u = c.getConfigNameMap(n), q = u.internal, l = u.initialized, v = u.apply, o = u.update, t = u.set, m = u.get, y = (t in i)
													|| k.hasOwnProperty(t), p = (v in i)
													|| k.hasOwnProperty(v), r = (o in i)
	...
	Ext.extend = function(j, k, i) {
		...
		i.extend = k;
		i.preprocessors = [ "extend", "statics", "inheritableStatics",
				"mixins", "config" ];
		if (j) {
			h = new c(j, i);
			...
			.registerPreprocessor(
					...
					function(u, o) {
						var s = u.prototype, l = d(o.xtype), j = d(o.alias), v = "widget.", t = v.length, p = Array.prototype.slice
								.call(s.xtypesChain || []), m = Ext.merge({},
								s.xtypesMap || {}), n, r, q, k;
...
Ext.Loader = new function() {
	var j = this, b = Ext.ClassManager, r = Ext.Class, e = Ext.Function.flexSetter, m = Ext.Function.alias, a = Ext.Function.pass, d = Ext.Function.defer, h = Ext.Array.erase, l = [
			"extend", "mixins", "requires" ], t = {}, k = [], c = /\/\.\//g, g = /\./g;
	Ext.apply(j, {
		isInHistory : t,
		history : k,
		config : {
			...
			.apply(
					j,
					{
						...
						injectScriptElement : function(w, D, A, F, y) {
							var E = document.createElement("script"), B = false, x = j.config, C = function() {
								if (!B) {
									...
									j.cleanupScriptElement(E,
											x.preserveScripts === false,
											x.garbageCollect)
								}
							}, z = function(G) {
								d(A, 1, F);
						...
						removeScriptElement : function(w) {
							if (n[w]) {
								j.cleanupScriptElement(n[w], true, !!j
						...
						loadScript : function(F) {
							var z = j.getConfig(), y = typeof F == "string", x = y ? F
									: F.url, B = !y && F.onError, C = !y
									&& F.onLoad, E = !y && F.scope, D = function() {
								j.numPendingFiles--;
								j.scriptsLoading--;
								if (B) {
									B
							...
							j.numPendingFiles++;
							j.scriptsLoading++;
							w = z.disableCaching ? (x + "?"
									+ z.disableCachingParam + "=" + Ext.Date
									.now()) : x;
						...
						loadScriptFile : function(x, E, C, H, w) {
							...
							if (!w) {
								...
								A = (G.status === 1223) ? 204
										: (G.status === 0 && (self.location || {}).protocol == "file:") ? 200
												: G.status;
								y = y || (A === 0);
								if (y) {
								} else {
						...
						require : function(O, F, z, B) {
							...
							for (L = 0; L < G; L++) {
								...
								if (!p.hasOwnProperty(C)) {
									...
									q[C] = J;
									j.numPendingFiles++;
									j.loadScriptFile(J, a(j.onFileLoaded, [ C,
											J ], j), a(j.onFileLoadError, [ C,
											J ], j), j, P)
								}
							}
							if (P) {
	...
	var me = this, encodingFunction, decodingFunction, useNative = null, useHasOwn = !!{}.hasOwnProperty, isNative = function() {
		...
		for (i in o) {
			if (!useHasOwn || o.hasOwnProperty(i)) {
				a.push(Ext.JSON.encodeValue(i), ":",
						Ext.JSON.encodeValue(o[i]), ",")
			}
		}
		a[a.length - 1] = "}";
		return a.join("")
		...
		.apply(
				Ext,
				{
					...
					addCacheEntry : function(e, b, d) {
						d = d || b.dom;
						var a = e || (b && b.id) || d.id, c = Ext.cache[a]
								|| (Ext.cache[a] = {
									data : {},
									events : {},
									dom : d,
					...
					escapeId : (function() {
						...
						return function(g) {
							return c.test(g) ? g : g.replace(d, a)
									.replace(b, e)
						}
					}()),
					getBody : (function() {
...
(function() {
	...
	}, p = document.documentMode, a = o(/opera/), v = a && o(/version\/10\.5/), K = o(/\bchrome\b/), z = o(/webkit/), c = !K
			&& o(/safari/), I = c && o(/applewebkit\/4/), G = c
			&& o(/version\/3/), D = c && o(/version\/4/), j = c
			&& o(/version\/5\.0/), C = c && o(/version\/5/), i = !a
			&& o(/msie/), J = i
			&& ((o(/msie 7/) && p != 8 && p != 9) || p == 7), H = i
			&& ((o(/msie 8/) && p != 7 && p != 9) || p == 8), E = i
			&& ((o(/msie 9/) && p != 7 && p != 8) || p == 9), M = i
			&& o(/msie 6/), b = !z && o(/gecko/), P = b && o(/rv:1\.9/), O = b
			&& o(/rv:2\.0/), N = b && o(/rv:5\./), r = b && o(/rv:10\./), y = P
			&& o(/rv:1\.9\.0/), w = P && o(/rv:1\.9\.1/), u = P
			&& o(/rv:1\.9\.2/), g = o(/windows|win32/), B = o(/macintosh|mac os x/), x = o(/linux/), l = null, m = F(
			true, /\bchrome\/(\d+\.\d+)/), h = F(true, /\bfirefox\/(\d+\.\d+)/), n = F(
			i, /msie (\d+\.\d+)/), s = F(a, /version\/(\d+\.\d+)/), d = F(c,
			/version\/(\d+\.\d+)/), A = F(z, /webkit\/(\d+\.\d+)/), q = /^https/i
			.test(window.location.protocol), k;
	try {
	...
	Ext
			.apply(
					Ext,
					{
						...
						webKitVersion : A,
						isSecure : q,
						BLANK_IMAGE_URL : (M || J) ? "//www.sencha.com/s.gif"
						...
						getScrollbarSize : function(Q) {
							...
							if (Q || !l) {
								var e = document.body, R = document
										.createElement("div");
						...
						invoke : function(e, T) {
							var V = [], U = Array.prototype.slice.call(
									arguments, 2), Q, S, R = e.length;
							for (Q = 0; Q < R; Q++) {
								S = e[Q];
						...
						zip : function() {
							...
							}), T = W[0], V = W[1][0], e = Ext.max(Ext.pluck(T,
									"length")), S = [], U, R, Q;
							for (U = 0; U < e; U++) {
								S[U] = [];
								if (V) {
						...
						toSentence : function(Q, e) {
							...
							if (T <= 1) {
								...
								S = Q.slice(0, T - 1);
								R = Q[T - 1];
								return Ext.util.Format.format("{0} {1} {2}", S
										.join(", "), e || "and", R)
							}
						},
						useShims : M
			...
			.apply(
					g,
					{
						...
						substr : "ab".substr(-1) != "b" ? function(i, k, h) {
							var j = String(i);
							return (k < 0) ? j.substr(
									Math.max(j.length + k, 0), h) : j.substr(k,
									h)
						} : function(i, j, h) {
						...
						currency : function(k, m, j, h) {
							...
							if ((h || g.currencyAtEnd) === true) {
								return Ext.String.format("{0}{1}{2}", o, k, m
										|| g.currencySign)
							} else {
								return Ext.String.format("{0}{1}{2}", o, m
										|| g.currencySign, k)
							}
						},
						date : function(h, i) {
							...
							return Ext.Date.dateFormat(h, i
						...
						fileSize : function(h) {
							if (h < 1024) {
								...
								if (h < 1048576) {
									return (Math.round(((h * 10) / 1024)) / 10)
											+ " KB"
								} else {
									return (Math.round(((h * 10) / 1048576)) / 10)
											+ " MB"
								}
							}
						},
						math : (function() {
							...
							return function(j, i) {
								if (!h[i]) {
									h[i] = Ext.functionFactory("v", "return v "
											+ i + ";")
								}
								return h[i](j)
							}
		...
		.define(
				"Ext.util.TaskRunner",
				{
					...
					start : function(a) {
						...
						a.stopped = false;
						a.taskStartTime = b;
						a.taskRunTime = a.fireOnStart !== false ? 0
								: a.taskStartTime;
						a.taskRunCount = 0;
						if (!c.firing) {
		...
		.define(
				"Ext.perf.Monitor",
				{
					...
					get : function(b) {
						...
						if (!a) {
							c.accumulatorsByName[b] = a = new Ext.perf.Accumulator(
									b);
					...
					report : function() {
						...
						b.sort(function(e, d) {
							return (e.name < d.name) ? -1
									: ((d.name < e.name) ? 1 : 0)
						});
						c.updateGC();
						Ext.log("Calibration: " + Math.round(a * 100) / 100
								+ " msec/sample");
...
(function() {
	var a = function(d, c) {
		var b = d.ownerDocument.defaultView, e = (b ? b.getComputedStyle(d,
				null) : d.currentStyle)
				|| d.style;
		return e[c]
	};
	Ext.supports = {
		init : function() {
			var d = this, e = document, c = d.tests, i = c.length, h = i
					&& Ext.isReady && e.createElement("div"), g, b = [];
			if (h) {
				h.innerHTML = [
		...
		tests : [
				{
					...
					fn : function(h, k) {
						var g = [ "webkit", "Moz", "o", "ms", "khtml" ], j = "TransitionEnd", b = [
								g[0] + j, "transitionend", g[2] + j, g[3] + j,
								g[4] + j ], e = g.length, d = 0, c = false;
						for (; d < e; d++) {
				...
				},
				{
					...
					fn : function(c, d) {
						...
						return !(b && b.getComputedStyle(
								d.firstChild.firstChild, null).marginRight != "0px")
					}
				},
				{
				...
				},
				{
					...
					fn : function(h, j) {
						var g = "background-image:", d = "-webkit-gradient(linear, left top, right bottom, from(black), to(white))", i = "linear-gradient(left top, black, white)", e = "-moz-"
								+ i, b = "-o-" + i, c = [ g + d, g + i, g + e,
								g + b ];
						j.style.cssText = c.join(";");
						return ("" + j.style.backgroundImage)
								.indexOf("gradient") !== -1
					}
				},
				{
					...
					fn : function(e, g) {
						var c = [ "borderRadius", "BorderRadius",
								"MozBorderRadius", "WebkitBorderRadius",
								"OBorderRadius", "KhtmlBorderRadius" ], d = false, b;
				...
				},
				{
					...
					fn : function() {
						return Ext
								.isString(document.body.style.msTransformOrigin)
					}
				},
				{
				...
				},
				{
					...
					fn : function() {
						var b = Ext.supports.Range ? document.createRange()
								: false;
										...
										return {
											...
											addListener : function(i, h, g) {
												...
												if (!j.isListening(i, h)) {
													k = j.createListener(i, h,
															g);
													if (j.firing) {
														j.listeners = j.listeners
																.slice(0)
													}
													j.listeners.push(k)
												}
											...
											fire : function() {
												...
												if (k > 0) {
													...
													for (h = 0; h < k; h++) {
														m = j[h];
														g = arguments.length ? Array.prototype.slice
																.call(
																		arguments,
																		0)
																: [];
...
Ext.EventManager = new function() {
	var a = this, d = document, c = window, b = function() {
		var k = d.body || d.getElementsByTagName("body")[0], i = Ext.baseCSSPrefix, o = [ i
				+ "body" ], g = [], m = Ext.supports.CSS3LinearGradient, l = Ext.supports.CSS3BorderRadius, h = [], j, e;
		if (!k) {
			return false
		}
		j = k.parentNode;
			...
			.apply(
					a,
					{
						...
						isReadyPaused : function() {
							return (/[?&]ext-pauseReadyFire\b/i
									.test(location.search) && !Ext._continueFireReady)
						},
						bindReadyEvent : function() {
							...
							if (d.readyState == "complete") {
								...
								document.addEventListener("DOMContentLoaded",
										a.onReadyEvent, false);
								window.addEventListener("load", a.onReadyEvent,
										false);
						...
						onReadyEvent : function(g) {
							...
							if (a.hasBoundOnReady) {
								document.removeEventListener(
										"DOMContentLoaded", a.onReadyEvent,
										false);
						...
						fireDocReady : function() {
							if (!Ext.isReady) {
								...
								if (Ext.isNumber(a.deferReadyEvent)) {
									Ext.Function.defer(a.fireReadyEvent,
											a.deferReadyEvent);
						...
						normalizeEvent : function(e, g) {
							if (a.mouseEnterLeaveRe.test(e)
									&& !Ext.supports.MouseEnterLeave) {
								if (g) {
									g = Ext.Function.createInterceptor(g,
											a.contains)
								}
								e = e == "mouseenter" ? "mouseover"
										: "mouseout"
							} else {
								if (e == "mousewheel"
						...
						contains : function(g) {
							var e = g.browserEvent.currentTarget, h = a
									.getRelatedTarget(g);
							if (e && e.firstChild) {
								while (h) {
									if (h === e) {
						...
						addListener : function(h, e, k, j, g) {
							...
							if (l.attachEvent) {
								...
								l.addEventListener(m.eventName, i,
										g.capture || false)
							}
							if (l == d && e == "mousedown") {
								a.stoppedMouseDownEvent.addListener(i)
							}
							a.getEventListenerCache(h.dom ? h : l, e).push({
								fn : k,
								wrap : i,
								scope : j
							})
						...
						removeListener : function(p, q, r, t) {
							...
							var n = Ext.getDom(p), h = p.dom ? p : Ext.get(n), e = a
									.getEventListenerCache(h, q), s = a
									.normalizeEvent(q).eventName, o = e.length, m, k, g, l;
							while (o--) {
								k = e[o];
								if (k && (!r || k.fn == r)
										&& (!t || k.scope === t)) {
							...
							var k, j, e = /\\/g, g = function(p, o) {
								if (!j) {
									...
									if (n.buffer || n.delay || n.freezeEvent) {
										k.push("e = new X.EventObjectImpl(e, "
												+ (n.freezeEvent ? "true"
														: "false") + ");")
									} else {
										k
												.push("e = X.EventObject.setEvent(e);")
									}
									if (n.delegate) {
										k.push('var result, t = e.getTarget("'
												+ (n.delegate + "").replace(e,
														"\\\\") + '", this);');
										k.push("if(!t) {return;}")
									} else {
									...
									if (n.target) {
										k
												.push("if(e.target !== options.target) {return;}")
									}
									if (n.stopEvent) {
										k.push("e.stopEvent();")
									} else {
									...
									if (n.buffer) {
										k
												.push("(wrap.task && clearTimeout(wrap.task));");
										k
												.push("wrap.task = setTimeout(function() {")
									}
									if (n.delay) {
										k
												.push("wrap.tasks = wrap.tasks || [];");
										k
												.push("wrap.tasks.push(setTimeout(function() {")
									}
									k
											.push("result = fn.call(scope || dom, e, t, options);");
									if (n.single) {
										k
												.push("evtMgr.removeListener(dom, ename, fn, scope);")
									}
									if (h !== "mousemove") {
										k
												.push("if (evtMgr.idleEvent.listeners.length) {");
									...
									j = Ext.cacheableFunctionFactory("e",
											"options", "fn", "scope", "ename",
											"dom", "wrap", "args", "X",
											"evtMgr", k.join("\n"))
								}
								return j
										.call(i, p, n, l, m, h, i, g, o, Ext, a)
							};
							return g
						},
						...
						resolveTextNode : Ext.isGecko ? function(g) {
							...
							if (e == "[xpconnect wrapped native prototype]"
									|| e == "[object XULElement]") {
								return
							}
						...
						fireResize : function() {
							var e = Ext.Element.getViewWidth(), g = Ext.Element
									.getViewHeight();
						...
						useKeyDown : Ext.isWebKit ? parseInt(
								navigator.userAgent.match(/AppleWebKit\/(\d+)/)[1],
								10) >= 525
				...
				"Ext.dom.AbstractHelper",
				{
								...
								for (b in d) {
									if (d.hasOwnProperty(b)) {
										...
										if (!h.confRe.test(b)) {
											if (typeof j == "object") {
												c.push(" ", b, '="');
												h.generateStyles(j, c)
														.push('"')
											} else {
												c.push(" ",
														h.attributeTransform[b]
																|| b, '="', j,
														'"')
											}
										}
					...
					applyStyles : function(d, e) {
						if (e) {
							...
							if (typeof e == "string") {
								e = Ext.util.Format.trim(e).split(
										/\s*(?::|;)\s*/);
								for (a = e.length; b < a;) {
									d.setStyle(e[b++], e[b++])
								}
					...
					insertHtml : function(g, a, h) {
						...
						j = "setStart"
								+ (this.endRe.test(g) ? "After" : "Before");
						if (e[g]) {
							i[j](a);
							k = i.createContextualFragment(h);
							a.parentNode.insertBefore(k, g == "beforebegin" ? a
									: a.nextSibling);
							return a[(g == "beforebegin" ? "previous" : "next")
									+ "Sibling"]
						} else {
							d = (g == "afterbegin" ? "first" : "last")
									+ "Child";
							if (a.firstChild) {
								i[j](a[d]);
								k = i.createContextualFragment(h);
					...
					insertAfter : function(a, c, b) {
						return this
								.doInsert(a, c, b, "afterend", "nextSibling")
					},
					...
					doInsert : function(d, g, e, h, c, a) {
						var b = this.insertHtml(h, Ext.getDom(d), this
								.markup(g));
			...
			.define(
					"Ext.dom.AbstractElement",
					{
						...
						constructor : function(d, e) {
							var g = this, h = typeof d == "string" ? a
									.getElementById(d) : d, i;
							if (!h) {
								return null
							}
							i = h.id;
						...
						contains : function(d) {
							...
							return (g === e.dom)
									|| Ext.dom.AbstractElement.isAncestor(
											e.dom, g)
						},
						getAttribute : function(d, e) {
							var g = this.dom;
							return g.getAttributeNS(e, d)
									|| g.getAttribute(e + ":" + d)
									|| g.getAttribute(d) || g[d]
						},
						update : function(d) {
							if (this.dom) {
						...
						setVisible : function(j, d) {
							...
							switch (h) {
							case i.VISIBILITY:
								e.removeCls([ g + "hidden-display",
										g + "hidden-offsets" ]);
								e[j ? "removeCls" : "addCls"](g
										+ "hidden-visibility");
								break;
							case i.DISPLAY:
								e.removeCls([ g + "hidden-visibility",
										g + "hidden-offsets" ]);
								e[j ? "removeCls" : "addCls"](g
										+ "hidden-display");
								break;
						...
						getCache : function() {
							...
							d.$cache = Ext.cache[e]
									|| Ext.addCacheEntry(e, null, d.dom);
							return d.$cache
						}
					},
					function() {
									...
									Fly : new Ext.Class(
											{
												...
												attach : function(e) {
													this.dom = e;
													this.$cache = e.id ? Ext.cache[e.id]
															: null;
													return this
												}
											}),
...
Ext.dom.AbstractElement.addInheritableStatics({
	...
	unitizeBox : function(g, e) {
		...
		return d(c.top, e) + " " + d(c.right, e) + " " + d(c.bottom, e) + " "
				+ d(c.left, e)
	},
...
(function() {
	var g = document, a = Ext.dom.AbstractElement, e = null, d = g.compatMode == "CSS1Compat", c, b = function(
			i) {
		if (!c) {
			c = new a.Fly()
		}
	...
	a
			.addInheritableStatics({
				...
				getViewWidth : function(i) {
					return i ? Ext.dom.Element.getDocumentWidth()
							: Ext.dom.Element.getViewportWidth()
				},
				getViewHeight : function(i) {
					return i ? Ext.dom.Element.getDocumentHeight()
							: Ext.dom.Element.getViewportHeight()
				},
				getDocumentHeight : function() {
					return Math.max(!d ? g.body.scrollHeight
							: g.documentElement.scrollHeight, Ext.dom.Element
							.getViewportHeight())
				},
				getDocumentWidth : function() {
					return Math.max(!d ? g.body.scrollWidth
							: g.documentElement.scrollWidth, Ext.dom.Element
							.getViewportWidth())
				},
				getViewportHeight : function() {
				...
				getXY : function(k) {
					var n = g.body, j = g.documentElement, i = 0, l = 0, o = [
							0, 0 ], r = Math.round, m, q;
					k = Ext.getDom(k);
					if (k != g && k != n) {
						if (Ext.isIE) {
							try {
				...
				serializeForm : function(k) {
					var l = k.elements
							|| (document.forms[k] || Ext.getDom(k)).elements, v = false, u = encodeURIComponent, p = "", n = l.length, q, i, t, x, w, r, m, s, j;
					for (r = 0; r < n; r++) {
						q = l[r];
						i = q.name;
						t = q.type;
							...
							if (/select-(one|multiple)/i.test(t)) {
								...
								for (m = 0; m < s; m++) {
									...
									if (j.selected) {
										w = j.hasAttribute ? j
												.hasAttribute("value")
												: j.getAttributeNode("value").specified;
										p += Ext.String.format("{0}={1}&",
												u(i), u(w ? j.value : j.text))
									}
								}
							} else {
								if (!(/file|undefined|reset|button/i.test(t))) {
									if (!(/radio|checkbox/i.test(t) && !q.checked)
											&& !(t == "submit" && v)) {
										p += u(i) + "=" + u(q.value) + "&";
										v = /submit/i.test(t)
									}
...
Ext.dom.AbstractElement
		.override({
			getAnchorXY : function(g, k, n) {
				g = (g || "tl").toLowerCase();
				n = n || {};
				var j = this, a = j.dom == document.body || j.dom == document, b = n.width
						|| a ? window.innerWidth : j.getWidth(), l = n.height
						|| a ? window.innerHeight : j.getHeight(), m, c = Math.round, d = j
						.getXY(), i = a ? 0 : !k ? d[0] : 0, h = a ? 0
						: !k ? d[1] : 0, e = {
					c : [ c(b * 0.5), c(l * 0.5) ],
					t : [ c(b * 0.5), 0 ],
					l : [ 0, c(l * 0.5) ],
...
Ext.dom.AbstractElement.addMethods({
	...
	insertSibling : function(b, g, j) {
		...
		b = b || {};
		if (b.nodeType || b.dom) {
			d = i.dom.parentNode.insertBefore(Ext.getDom(b),
					k ? i.dom.nextSibling : i.dom);
			if (!j) {
				d = Ext.get(d)
			}
		} else {
			if (k && !i.dom.nextSibling) {
				...
				d = Ext.core.DomHelper[k ? "insertAfter" : "insertBefore"](
						i.dom, b, !j)
			}
		}
		return d
	...
	replaceWith : function(a) {
		...
		b.id = Ext.id(b.dom = a);
		Ext.dom.AbstractElement
				.addToCache(b.isFlyweight ? new Ext.dom.AbstractElement(b.dom)
						: b);
		return b
	},
...
(function() {
	...
	a
			.override({
				...
				getXY : function() {
					var b = window.webkitConvertPointFromNodeToPage(this.dom,
							new WebKitPoint(0, 0));
					return [ b.x, b.y ]
				},
				...
				translatePoints : function(b, i) {
					i = isNaN(b[1]) ? i : b[1];
					b = isNaN(b[0]) ? b : b[0];
					var e = this, g = e.isStyle("position", "relative"), h = e
							.getXY(), c = parseInt(e.getStyle("left"), 10), d = parseInt(
							e.getStyle("top"), 10);
				...
				getBox : function(i, m) {
					...
					if (!m) {
						...
						if (i) {
							...
							p = [ parseInt(j.getStyle("left"), 10) || 0,
									parseInt(j.getStyle("top"), 10) || 0 ]
						}
					}
					if (!i) {
						h = {
						...
						e = j.getBorderWidth.call(j, "l")
								+ j.getPadding.call(j, "l");
						c = j.getBorderWidth.call(j, "r")
								+ j.getPadding.call(j, "r");
						o = j.getBorderWidth.call(j, "t")
								+ j.getPadding.call(j, "t");
						k = j.getBorderWidth.call(j, "b")
								+ j.getPadding.call(j, "b");
						h = {
							x : p[0] + e,
							y : p[1] + o,
							0 : p[0] + e,
				...
				getPageBox : function(g) {
					var j = this, d = j.dom, m = d.offsetWidth, i = d.offsetHeight, o = j
							.getXY(), n = o[1], c = o[0] + m, k = o[1] + i, e = o[0];
					if (!d) {
...
(function() {
	var q = Ext.dom.AbstractElement, o = document.defaultView, n = Ext.Array, m = /^\s+|\s+$/g, b = /\w/g, p = /\s+/, t = /^(?:transparent|(?:rgba[(](?:\s*\d+\s*[,]){3}\s*0\s*[)]))$/i, h = Ext.supports.ClassList, e = "padding", d = "margin", s = "border", k = "-left", r = "-right", l = "-top", c = "-bottom", i = "-width", j = {
		l : s + k + i,
		r : s + r + i,
		t : s + l + i,
		b : s + c + i
			...
			.override({
				...
				getStyle : function(G, B) {
					...
					if (B) {
						...
						u = x.ownerDocument.defaultView.getComputedStyle(x,
								null);
						if (!u) {
							B = true;
							u = z
				...
				getHeight : function(v) {
					var w = this.dom, u = v ? (w.clientHeight - this
							.getPadding("tb")) : w.offsetHeight;
					return u > 0 ? u : 0
				},
				getWidth : function(u) {
					var w = this.dom, v = u ? (w.clientWidth - this
							.getPadding("lr")) : w.offsetWidth;
					return v > 0 ? v : 0
				},
				setWidth : function(u) {
					var v = this;
				...
				getSize : function(v) {
					var u = this.dom;
					return {
						width : Math.max(0, v ? (u.clientWidth - this
								.getPadding("lr")) : u.offsetWidth),
						height : Math.max(0, v ? (u.clientHeight - this
				...
				unmask : function() {
					...
					if (v.dom === document.body) {
						Ext.EventManager.unOrientationChange(
								v.orientationHandler, v);
						delete v.orientationHandler
					}
				}
			});
	q.populateStyleMap = function(B, u) {
		var A = [ "margin-", "padding-", "border-width-" ], z = [ "before",
				"after" ], w, y, v, x;
		for (w = A.length; w--;) {
			for (x = 2; x--;) {
				y = A[w] + z[x];
				B[q.normalize(y)] = B[y] = {
					name : q.normalize(A[w] + u[x])
				}
			}
		}
	};
			...
			.onReady(function() {
				...
				function x(J, G, I, F) {
					...
					if (D != "0px") {
						...
						D = (I ? F : J.ownerDocument.defaultView
								.getComputedStyle(J, null)).marginRight;
						E.display = H
					}
					return D
				}
				function w(K, H, J, G) {
					...
					if (D != "0px") {
						...
						D = (J ? G : K.ownerDocument.defaultView
								.getComputedStyle(K, "")).marginRight;
						F.display = I;
						E()
					}
					return D
				...
				if (!C.RightMargin) {
					u.marginRight = u["margin-right"] = {
						name : "marginRight",
						get : (C.DisplayChangeInputSelectionBug || C.DisplayChangeTextAreaSelectionBug) ? w
								: x
					}
				}
				if (!C.TransparentColor) {
					A = [ "background-color", "border-color", "color",
							"outline-color" ];
					for (y = A.length; y--;) {
						v = A[y];
						B = q.normalize(v);
...
Ext.dom.Query = Ext.core.DomQuery = Ext.DomQuery = (function() {
	var cache = {}, simpleCache = {}, valueCache = {}, nonSpace = /\S/, trimRe = /^\s+|\s+$/g, tplRe = /\{(\d+)\}/g, modeRe = /^(\s?[\/>+~]\s?|\s|$)/, tagTokenRe = /^(#)?([\w\-\*\\]+)/, nthRe = /(\d*)n\+?(\d*)/, nthRe2 = /\D/, startIdRe = /^\s*\#/, isIE = window.ActiveXObject ? true
			: false, key = 30803, longHex = /\\([0-9a-fA-F]{6})/g, shortHex = /\\([0-9a-fA-F]{1,6})\s{0,1}/g, nonHex = /\\([^0-9a-fA-F]{1})/g, escapes = /\\/g, num, hasEscapes, longHexToChar = function(
			$0, $1) {
		...
		return (hasEscapes) ? selector.replace(longHex, longHexToChar)
				: selector
...
(function() {
	var HIDDEN = "hidden", DOC = document, VISIBILITY = "visibility", DISPLAY = "display", NONE = "none", XMASKED = Ext.baseCSSPrefix
			+ "masked", XMASKEDRELATIVE = Ext.baseCSSPrefix + "masked-relative", EXTELMASKMSG = Ext.baseCSSPrefix
			+ "mask-msg", bodyRe = /^body/i, visFly, noBoxAdjust = Ext.isStrict ? {
		select : 1
	}
			: {
				input : 1,
			...
			.define(
					"Ext.dom.Element",
					{
						...
						alternateClassName : [ "Ext.Element",
								"Ext.core.Element" ],
						addUnits : function() {
							return this.self.addUnits.apply(this.self,
									arguments)
						},
						...
						hover : function(overFn, outFn, scope, options) {
							var me = this;
							me.on("mouseenter", overFn, scope || me.dom,
									options);
							me
									.on("mouseleave", outFn, scope || me.dom,
											options);
							return me
						},
						...
						getAttribute : (Ext.isIE && !(Ext.isIE9 && DOC.documentMode === 9)) ? function(
								name, ns) {
							var d = this.dom, type;
							if (ns) {
							...
							return d[name] || null
								...
								: function(name, ns) {
									...
									return d.getAttribute(name) || d[name]
											|| null
								},
						...
						mask : function(msg, msgCls, elHeight) {
							var me = this, dom = me.dom, setExpression = dom.style.setExpression, data = (me.$cache || me
									.getCache()).data, maskEl = data.maskEl, maskMsg = data.maskMsg;
							if (!(bodyRe.test(dom.tagName) && me
							...
							if (!Ext.supports.IncludePaddingInHeightCalculation
									&& setExpression) {
								try {
									maskEl.dom.style
											.setExpression(
								...
								if (Ext.isIE && !(Ext.isIE7 && Ext.isStrict)
									...
									maskEl.setSize(undefined, elHeight
											|| me.getHeight())
								}
							}
							return maskEl
						...
						createShim : function() {
							...
							shim = Ext.get(this.dom.parentNode.insertBefore(el,
									this.dom));
						...
						on : function(eventName, fn, scope, options) {
							Ext.EventManager.on(this, eventName, fn, scope
									|| this, options);
							return this
						},
						un : function(eventName, fn, scope) {
							Ext.EventManager.un(this, eventName, fn, scope
									|| this);
							return this
						},
					...
					function() {
						...
						El.collectorThreadId = setInterval(garbageCollect,
								30000);
						El
								.addMethods({
									monitorMouseLeave : function(delay,
											handler, scope) {
										var me = this, timer, listeners = {
											mouseleave : function(e) {
												timer = setTimeout(Ext.Function
														.bind(handler, scope
																|| me, [ e ]),
														delay)
											},
									...
									swallowEvent : function(eventName,
											preventDefault) {
										var me = this, e, eLen;
										function fn(e) {
											e.stopPropagation();
									...
									clean : function(forceReclean) {
										var me = this, dom = me.dom, data = (me.$cache || me
												.getCache()).data, n = dom.firstChild, ni = -1, nx;
										if (data.isCleaned
												&& forceReclean !== true) {
											return me
										}
									...
									getLoader : function() {
										var me = this, data = (me.$cache || me
												.getCache()).data, loader = data.loader;
										if (!loader) {
									...
									update : function(html, loadScripts,
										...
										interval = setInterval(
												function() {
													...
													Ext.removeNode(el);
													hd = Ext.getHead().dom;
													while ((match = scriptTagRe
															.exec(html))) {
														attrs = match[1];
														srcMatch = attrs ? attrs
																.match(srcRe)
																: false;
														if (srcMatch
																&& srcMatch[2]) {
									...
									createProxy : function(config, renderTo,
										...
										var me = this, proxy = renderTo ? Ext.DomHelper
												.append(renderTo, config, true)
									...
									needsTabIndex : function() {
										if (this.dom) {
											if ((this.dom.nodeName === "a")
													&& (!this.dom.href)) {
												return true
											}
											return !focusRe
													.test(this.dom.nodeName)
										}
									},
									focusable : function() {
						...
						if (Ext.isIE) {
							El.prototype.getById = function(id, asDom) {
								...
								if (dom) {
									el = (useDocForId && DOC.getElementById(id))
											|| dom.all[id];
									if (el) {
										if (asDom) {
											ret = el
						...
						if (Ext.isIE) {
							Ext.getElementById = function(id) {
								...
								if (!el
										&& (detachedBodyEl = AbstractElement.detachedBodyEl)) {
...
Ext.dom.Element
		.override((function() {
			...
			return {
				getAnchorXY : function(j, o, h) {
					j = (j || "tl").toLowerCase();
					h = h || {};
					var m = this, i = m.dom == d.body || m.dom == d, e = h.width
							|| i ? Ext.dom.Element.getViewWidth() : m
							.getWidth(), g = h.height || i ? Ext.dom.Element
							.getViewHeight() : m.getHeight(), q, n = m.getXY(), p = m
							.getScroll(), l = i ? p.left : !o ? n[0] : 0, k = i ? p.top
							: !o ? n[1] : 0;
					switch (j) {
					case "tl":
						q = [ 0, 0 ];
				...
				getAlignToXY : function(m, G, j) {
					...
					G = (!G || G == "?" ? "tl-bl?" : (!(/-/).test(G)
							&& G !== "" ? "tl-" + G : G || "tl-bl"))
							.toLowerCase();
					var H = this, l, w, q, o, k, z, A, E = Ext.dom.Element
							.getViewWidth() - 10, i = Ext.dom.Element
							.getViewHeight() - 10, g, h, n, p, u, v, F = d.documentElement, s = d.body, D = (F.scrollLeft
							|| s.scrollLeft || 0), B = (F.scrollTop
							|| s.scrollTop || 0), C, t, r, e = G.match(a);
					t = e[1];
					r = e[2];
					C = !!e[3];
				...
				anchorTo : function(g, l, h, e, o, p) {
					...
					if (n) {
						Ext.EventManager.on(c, "scroll", i, null, {
							buffer : !isNaN(o) ? o : 50
						})
					}
					i.call(m);
				...
				alignTo : function(h, e, j, g) {
					var i = this;
					return i.setXY(i.getAlignToXY(h, e, j), i.anim && !!g ? i
							.anim(g) : false)
				},
				getConstrainVector : function(i, g) {
					...
					var k = this.getRegion(), e = [ 0, 0 ], j = (this.shadow && !this.shadowDisabled) ? this.shadow
							.getShadowSize()
							: undefined, h = false;
					if (g) {
		...
		.override({
			...
			slideIn : function(c, b, d) {
				...
				i = function() {
					...
					k = g.getStyles("width", "height", "left", "right", "top",
			...
			puff : function(e) {
				var d = this, b, c = d.getBox(), a = d.getStyles("width",
			...
			frame : function(a, d, e) {
				...
				b = function() {
					c.show();
					var i = this, j = c.getBox(), h = Ext.getBody()
							.createChild({
								id : c.id + "-anim-proxy",
								style : {
									position : "absolute",
...
(function() {
	var r = Ext.dom.Element, n = "left", k = "right", q = "top", h = "bottom", o = "position", j = "static", x = "relative", p = "auto", v = "z-index", u = "BODY", c = "padding", t = "border", s = "-left", m = "-right", a = "-top", l = "-bottom", g = "-width", e = {
		l : t + s + g,
		r : t + m + g,
		t : t + a + g,
		b : t + l + g
		...
		t : c + a,
		b : c + l
	}, w = [ d.l, d.r, d.t, d.b ], b = [ e.l, e.r, e.t, e.b ], i = [
			"position", "top", "left" ];
	r
			.override({
				getX : function() {
				...
				translatePoints : function(z, G) {
					var B = this, A = B.getStyle(i), C = A.position == "relative", F = parseFloat(A.left), E = parseFloat(A.top), D = B
							.getXY();
					if (Ext.isArray(z)) {
						G = z[1];
						z = z[0]
				...
				getBox : function(D, I) {
					...
					if (!D) {
						...
						A = (parseFloat(K[e.l]) || 0)
								+ (parseFloat(C[d.l]) || 0);
						y = (parseFloat(K[e.r]) || 0)
								+ (parseFloat(C[d.r]) || 0);
						L = (parseFloat(K[e.t]) || 0)
								+ (parseFloat(C[d.t]) || 0);
						G = (parseFloat(K[e.b]) || 0)
								+ (parseFloat(C[d.b]) || 0);
						E = {
							x : M[0] + A,
							y : M[1] + L,
				...
				getPageBox : function(B) {
					var D = this, z = D.dom, F = z.nodeName == u, G = F ? Ext.dom.AbstractElement
							.getViewWidth()
							: z.offsetWidth, C = F ? Ext.dom.AbstractElement
							.getViewHeight() : z.offsetHeight, I = D.getXY(), H = I[1], y = I[0]
							+ G, E = I[1] + C, A = I[0];
					if (B) {
				...
				move : function(H, A, B) {
					var E = this, K = E.getXY(), I = K[0], G = K[1], C = [
							I - A, G ], J = [ I + A, G ], F = [ I, G - A ], z = [
							I, G + A ], D = {
						l : C,
						left : C,
						r : J,
				...
				setRegion : function(z, y) {
					return this.setBounds(z.left, z.top, z.right - z.left,
							z.bottom - z.top, y)
				}
			})
}());
Ext.dom.Element
		.override({
			...
			scrollBy : function(b, a, c) {
				...
				if (b) {
					d.scrollTo("left", Math.max(Math.min(e.scrollLeft + b,
							e.scrollWidth - e.clientWidth), 0), c)
				}
				if (a) {
					d.scrollTo("top", Math.max(Math.min(e.scrollTop + a,
							e.scrollHeight - e.clientHeight), 0), c)
				}
				return d
			},
			...
			scrollIntoView : function(b, g, c) {
				...
				var d = this.dom, i = this.getOffsetsTo(b), h = i[0]
						+ b.scrollLeft, l = i[1] + b.scrollTop, a = l
						+ d.offsetHeight, m = h + d.offsetWidth, p = b.clientHeight, o = parseInt(
						b.scrollTop, 10), e = parseInt(b.scrollLeft, 10), j = o
						+ p, n = e + b.clientWidth, k;
	...
	p
			.override({
				...
				adjustDirect2DDimension : function(w) {
					var B = this, v = B.dom, z = B.getStyle("display"), y = v.style.display, C = v.style.position, A = w === g ? 0
							: 1, k = v.currentStyle, x;
					if (z === "inline") {
						v.style.display = "inline-block"
					}
					v.style.position = z.match(n) ? "absolute" : "static";
					x = (parseFloat(k[w]) || parseFloat(k.msTransformOrigin
							.split(" ")[A]) * 2) % 1;
					v.style.position = C;
					if (z === "inline") {
						v.style.display = y
				...
				boxWrap : function(k) {
					...
					var v = Ext.get(this.insertHtml("beforeBegin",
							"<div class='" + k + "'>"
									+ Ext.String.format(p.boxMarkup, k)
									+ "</div>"));
					Ext.DomQuery.selectNode("." + k + "-mc", v.dom)
							.appendChild(this.dom);
					return v
				},
				getComputedHeight : function() {
					var v = this, k = Math.max(v.dom.offsetHeight,
							v.dom.clientHeight);
					if (!k) {
				...
				getComputedWidth : function() {
					var v = this, k = Math.max(v.dom.offsetWidth,
							v.dom.clientWidth);
					if (!k) {
				...
				getFrameWidth : function(v, k) {
					return (k && this.isBorderBox()) ? 0
							: (this.getPadding(v) + this.getBorderWidth(v))
				},
				...
				selectable : function() {
					...
					k
							.applyStyles("-moz-user-select: text; -khtml-user-select: text;");
...
Ext
		.define(
				"Ext.dom.CompositeElementLite",
				{
					...
					Ext.select = function() {
						return Ext.dom.Element.select.apply(Ext.dom.Element,
								arguments)
					}
				});
...
(function() {
	var j = document.getElementsByTagName("script"), h = j[j.length - 1], a = h.src, q = a
			.substring(0, a.lastIndexOf("/") + 1), c = Ext.Loader, p = Ext.ClassManager, l = this.ExtBootstrapData, m = l.nameToAliasesMap, g = l.alternateToNameMap, k, o, b, d;
	if (m) {
		for (b in m) {
	...
	if (g) {
		Ext.merge(p.maps.alternateToName, g)
	}
	c.setConfig({
		enabled : true,
		disableCaching : true,
